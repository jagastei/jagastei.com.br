export function findCardBrand(digits: string): string | null {
	...
	const patterns = {
        ...
        discover:  /^(?:6011[0-9]{12}|65[4-9][0-9]{13}|64[4-9][0-9]{13}|622(?:12[6-9]|1[3-9][0-9]|[2-8][0-9]{2}|9(?:0[0-1][0-9]|2[0-5]))[0-9]{10})$/,
        ...
        mastercard:/^(?:5[1-5][0-9]{14}|2(?:2[2-9][0-9]{2}|[3-6][0-9]{3}|7(?:0[0-1][0-9]|20))[0-9]{12})$/,
