        ...
        <div class="flex flex-1 flex-col p-4 lg:p-6 gap-4 lg:gap-6">
            ...
            <div class="space-y-6">
                        ...
                        <form @submit.prevent="submit" class="space-y-6">
                            <div class="grid gap-6">
                                <div class="space-y-2">
                                    ...
                                    <Input id="name" v-model="form.name" type="text" :disabled="form.processing"
                                        placeholder="Ex: Carteira Pessoal" maxlength="30" />
                ...
                <Card>
                    ...
                    <CardContent>
                        <Button variant="destructive" :disabled="deleteForm.processing" @click="confirmWalletDeletion">
                            Deletar carteira
                        </Button>
                            ...
                            <DialogContent>
                                <DialogHeader>
                                    ...
                                    <DialogDescription>
                                        ...
                                        esta carteira serão excluídos permanentemente.  
                                    </DialogDescription>
                                </DialogHeader>
                                ...
                                <DialogFooter>
                                    ...
                                    <Button variant="destructive" :disabled="deleteForm.processing"
                                        @click="deleteWallet">
                                        <Loader2 v-if="deleteForm.processing" class="size-4 mr-2 animate-spin" />
                                        Excluir carteira
                                    </Button>
                                </DialogFooter>
                            </DialogContent>
