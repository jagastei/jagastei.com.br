...
<template>
	...
	<div class="relative flex flex-col scroll-smooth">
				...
				<nav class="relative flex justify-between items-center">
					<div class="flex items-center md:gap-x-12">
						<Link href="/" class="flex items-center gap-2 group">
							...
							<span
								class="font-medium text-xl hidden sm:inline-block group-hover:text-primary transition-colors"
								>JaGastei</span
							>
						</Link>
					</div>
						...
						>
							...
							>
								...
								<span class="text-primary relative">
									simplificada
									<span
										class="absolute bottom-2 left-0 w-full h-1 bg-primary/30 rounded-full"
									></span>
								</span>
							</h1>
							...
							>
								<div class="relative">
									...
									<img
										width="2174"
										height="1464"
										class="pt-8 w-full rounded-b-xl dark:hidden"
										src="@/../images/dashboard.png"
									/>
									<img
										width="2174"
										height="1464"
										class="pt-8 w-full rounded-b-xl hidden dark:block"
					...
					<div class="mt-16 flex justify-center">
						...
						>
							<div class="p-8">
								...
								<p
									class="font-display text-5xl font-light tracking-tight text-foreground"
								>
									R$ 9,90<span class="text-base font-normal text-muted-foreground"
										>/mês</span
									>
								</p>
								...
								<ul role="list" class="mt-10 space-y-4">
									<li class="flex items-center">
										...
										<span class="ml-2 text-sm text-muted-foreground"
											>Integração com WhatsApp</span
										>
									</li>
									<li class="flex items-center">
										<CircleCheck class="size-5 flex-none text-primary" />
										<span class="ml-2 text-sm text-muted-foreground"
											>Sem limite de contas</span
										>
									</li>
									<li class="flex items-center">
										<CircleCheck class="size-5 flex-none text-primary" />
										<span class="ml-2 text-sm text-muted-foreground"
											>Sem limite de cartões</span
										>
									</li>
									<li class="flex items-center">
										<CircleCheck class="size-5 flex-none text-primary" />
										<span class="ml-2 text-sm text-muted-foreground"
											>Sem limite de transações</span
										>
									</li>
								</ul>
		...
		<footer class="relative border-t border-primary bg-card">
			...
			<div
				class="absolute top-0 w-full h-full flex items-center justify-center mx-auto px-4 sm:px-6 lg:px-8"
			>
				<div class="py-12 flex flex-col items-center gap-8">
					...
					<p class="text-sm text-muted-foreground">© JaGastei 2025</p>

					<p class="text-sm text-muted-foreground">
						{{ $t('Made by') }}
						<a
							href="https://github.com/diego-lipinski-de-castro"
							target="_blank"
							class="text-primary hover:text-primary/80 transition-colors underline"
							>diego-lipinski-de-castro</a
						>
					</p>
				</div>
			</div>
