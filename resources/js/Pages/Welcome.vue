					...
					<div class="mt-16 grid grid-cols-1 items-center gap-x-8 gap-y-10 lg:grid-cols-12">
						...
						<div class="lg:col-span-7">
							<div class="overflow-hidden rounded-xl border border-border bg-background shadow-sm">
								<div class="relative">
									<div class="absolute top-0 pl-2.5 inset-x-0 h-8 bg-card flex items-center gap-2">
									...
									<img width="2174" height="1464" class="pt-8 w-full rounded-b-xl dark:hidden" src="@/../images/dashboard.png" />
									<img width="2174" height="1464" class="pt-8 w-full rounded-b-xl hidden dark:block" src="@/../images/dashboard-dark.png" />
								</div>
							</div>
						</div>
					</div>
							...
							<div class="p-8">
								...
								<ul role="list" class="mt-10 space-y-4">
									<li class="flex items-start">
										...
										<span class="ml-3 text-sm text-muted-foreground">Envie 25 orçamentos e
											faturas</span>
									</li>
									<li class="flex items-start">
										<CircleCheck class="size-5 flex-none text-primary mt-0.5" />
										<span class="ml-3 text-sm text-muted-foreground">Conecte até 5 contas
											bancárias</span>
									</li>
									<li class="flex items-start">
										<CircleCheck class="size-5 flex-none text-primary mt-0.5" />
										<span class="ml-3 text-sm text-muted-foreground">Acompanhe até 50 despesas por
											mês</span>
									</li>
									<li class="flex items-start">
										<CircleCheck class="size-5 flex-none text-primary mt-0.5" />
										<span class="ml-3 text-sm text-muted-foreground">Suporte automatizado de folha
											de
											pagamento</span>
									</li>
									<li class="flex items-start">
										<CircleCheck class="size-5 flex-none text-primary mt-0.5" />
										<span class="ml-3 text-sm text-muted-foreground">Exporte até 12
											relatórios</span>
									</li>
									<li class="flex items-start">
										<CircleCheck class="size-5 flex-none text-primary mt-0.5" />
										<span class="ml-3 text-sm text-muted-foreground">Reconciliação em massa de
											transações</span>
									</li>
									<li class="flex items-start">
										<CircleCheck class="size-5 flex-none text-primary mt-0.5" />
										<span class="ml-3 text-sm text-muted-foreground">Acompanhe em múltiplas
											moedas</span>
									</li>
								</ul>
