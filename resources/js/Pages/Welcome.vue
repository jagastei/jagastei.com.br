...
<template>
	...
	<div class="flex flex-col scroll-smooth">
		<header
			class="py-6 sticky top-0 bg-background/80 backdrop-blur-sm z-50 border-b border-border/40"
		>
			...
			<section id="pricing" aria-label="Pricing" class="py-24 sm:py-32">
				<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
					...
					<div class="mt-16 flex justify-center">
						<div
							class="overflow-hidden rounded-2xl border border-border bg-card shadow-sm max-w-md w-full hover:shadow-lg transition-shadow duration-300"
						>
							<div class="p-8">
								<div
								...
								>
									R$ 49,90<span class="text-base font-normal text-muted-foreground"
										>/mês</span
									>
								</p>
