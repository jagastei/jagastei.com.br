...
onMounted(() => {
    setTimeout(() => {
        const nitros: HTMLElement[] = Array.from(document.querySelectorAll('[data-nitro]'));
...
<template>
    ...
    <CreateDialog :open="createBudgetDialogOpen" @close="createBudgetDialogOpen = false" />
            ...
            <div v-if="budgets.length === 0"
                ...
                <div class="flex flex-col items-center gap-1 text-center">
                    ...
                    <p class="text-sm text-muted-foreground">
                        Você pode começar a acompanhar sua evolução financeira após adicionar seu primeiro orçamento.
